#!/usr/bin/env python3
# app.py - versi diperkuat: DNS-check + auto-retry untuk trycloudflare
...
# --- KONFIGURASI ---
# Variabel ini akan di-overwrite oleh bootloader Colab (dari Fase 5)
ROOT_PATH = "/content" 
PORT = 8000

# Variabel konfigurasi tunnel
